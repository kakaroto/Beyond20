...
ρσ_unpack = ρσ_unpack_asarray(3, ρσ_unpack);
    ...
    (function(){
        ...
        function subRolls() {
            ...
            var repl, new_text;
            repl = (keep_original) ? "\\1\\2\\3[[\\2\\3]]\\4" : "\\1[[\\2\\3]]\\4";
            new_text = re.sub("(^|\\s)([0-9]*d[0-9]+)((?:\\s*[-+]\\s*[0-9]+)?)($|\\s)", repl, text);
            print("Replacing '" + text + "' with : " + new_text);
            return new_text;
        };
        if (!subRolls.__defaults__) Object.defineProperties(subRolls, {
            __defaults__ : {value: {keep_original:false}},
            __handles_kwarg_interpolation__ : {value: true},
            __argnames__ : {value: ["text", "keep_original"]}
        });
            ...
            if ((request.action === "whisper" || typeof request.action === "object" && ρσ_equals(request.action, "whisper"))) {
                ...
                if ((request.type === "skill" || typeof request.type === "object" && ρσ_equals(request.type, "skill"))) {
                    ...
                    roll += template("traits", (function(){
                        ...
                        ρσ_d["description"] = subRolls(request.description, true);
                        return ρσ_d;
                    }).call(this));
                    ...
                    if (higher > 0) {
                        properties["athigherlevels"] = description.slice(higher + "At Higher Levels.".length);
                    ...
                    if (ρσ_exists.n(request["cast-at"])) {
                        properties["hldmg"] = subRolls(request["cast-at"][0]) + request["cast-at"].slice(1) + " Level";
                    }
                    components = request.components;
                    while ((components !== "" && (typeof components !== "object" || ρσ_not_equals(components, "")))) {
