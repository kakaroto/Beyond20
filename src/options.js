...
ρσ_unpack = ρσ_unpack_asarray(7, ρσ_unpack);
    ...
    (function(){
        ...
        var options_list = ρσ_modules.utils.options_list;
        var createHTMLOption = ρσ_modules.utils.createHTMLOption;
        var getDefaultSettings = ρσ_modules.utils.getDefaultSettings;
        var initializeMarka = ρσ_modules.utils.initializeMarka;
        ...
        function save_settings() {
            var settings, option, cb;
            settings = {};
            var ρσ_Iter1 = ρσ_Iterable(options_list);
            for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
                option = ρσ_Iter1[ρσ_Index1];
                settings[ρσ_bound_index(option[0], settings)] = $("#" + option[0]).prop("checked");
            }
        ...
        function setupHTML() {
            ...
            cb = (function() {
                var ρσ_anonfunc = function (items) {
                    var option;
                    var ρσ_Iter2 = ρσ_Iterable(items.settings);
                    for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                        option = ρσ_Iter2[ρσ_Index2];
                        $("#" + option).prop("checked", (ρσ_expr_temp = items.settings)[(typeof option === "number" && option < 0) ? ρσ_expr_temp.length + option : option]);
                    }
                };
                if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                    __argnames__ : {value: ["items"]}
