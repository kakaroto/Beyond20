...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
        ...
        function rollSkillCheck(paneClass) {
            ...
            sendRoll("skill", "1d20" + modifier, (function(){
                var ρσ_d = {};
        ...
        function rollAbilityOrSavingThrow(paneClass, rollType) {
            ...
            sendRoll(rollType, "1d20" + modifier, (function(){
                var ρσ_d = {};
        ...
        function rollInitiative() {
            ...
            sendRoll("initiative", "1d20" + initiative, (function(){
                var ρσ_d = {};
...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
        ...
        function injectDiceToRolls() {
            var selector = ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true) ? undefined : arguments[0];
            var name = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? injectDiceToRolls.__defaults__.name : arguments[1];
            var ρσ_kwargs_obj = arguments[arguments.length-1];
            if (ρσ_kwargs_obj === null || typeof ρσ_kwargs_obj !== "object" || ρσ_kwargs_obj [ρσ_kwargs_symbol] !== true) ρσ_kwargs_obj = {};
        ...
        function injectRollButton(paneClass) {
            ...
            if (ρσ_in(paneClass, ρσ_list_decorate([ "ct-custom-skill-pane", "ct-skill-pane", "ct-ability-pane", "ct-ability-saving-throws-pane", "ct-initiative-pane" ]))) {
                ...
                ρσ_interpolate_kwargs.call(this, addRollButton, [paneClass, ".ct-sidebar__heading"].concat([ρσ_desugar_kwargs({text: "Display in Roll20", image: false})]));
                name = $(".ct-sidebar__heading").text();
